...
These are repository-administration steps, not settings active by this document. Boards, milestones, and ownership automation can be added when the contributor base needs them.
