...
and [client configuration updates](operator-clients.md),
...
and [application writes](operator-applications.md) and [client updates](operator-clients.md). Their protected-input and bounded
