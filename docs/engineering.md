...
The current scaffold has no domain authorization policy. An empty domain suite is not evidence that authentication is tested. Security-sensitive later slices require property, concurrency, failure, and protocol tests appropriate to their contracts.
