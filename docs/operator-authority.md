...
| `operator account show ID`                                      | Database/runtime access, enabled login configuration, active shared limiter and current administrator password | Verified actor, current password credential and administrator membership rechecked under the security fence. Read and its audit commit together; no password material is returned.                                                                                                                                                                |
...
privileged assurance level, complete
