...
| CLI                       | Partial     | Bootstrap, migration/signing/limiter journals, diagnostics, authenticated accounts, directory/catalog reads, application create/update and client configuration update | Scoped emergency authority, client creation/secret delivery and broader account/catalog commands |
