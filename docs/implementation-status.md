...
| CLI                       | Partial     | Bootstrap, migration/signing/limiter journals, diagnostics, authenticated account lifecycle, directory/catalog reads and application creation/updates | Scoped emergency authority, client writes and broader account/catalog commands        |
...
The binary embeds **28 forward migrations** in
