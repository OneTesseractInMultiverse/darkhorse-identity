...
| CLI                       | Partial     | Bootstrap and operation journals; authenticated accounts, application/client/access-catalog reads, application writes, client updates and secret inventory/retirement | Scoped emergency authority, client creation/secret delivery and broader account/catalog commands |
...
The binary embeds **31 forward migrations** in
...
| `0031`        | Access-catalog read audit commands and selector constraints                           |
