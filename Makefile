...
override CATALOG_ALL_DEFINITIONS := $(value CATALOG_ALL_DEFINITIONS)
export CATALOG_ALL_DEFINITIONS
...
override CATALOG_SECRET_ID := $(value CATALOG_SECRET_ID)
...
export CATALOG_TARGET CATALOG_OPERATION CATALOG_APPLICATION_ID CATALOG_CLIENT_ID CATALOG_SECRET_ID
...
benchmark-operators-baseline: ## Performance: longer CLI interference comparison and live revocation
	$(MAKE) benchmark BENCH_PROFILE=operator-baseline
