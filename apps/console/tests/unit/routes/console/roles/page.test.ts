...
import Page from '../../../../../src/routes/console/roles/+page.svelte';
afterEach(() => vi.unstubAllGlobals());
it('connects the static roles page to the protected catalog and marks its navigation', async () => {
	...
	expect(fetcher).toHaveBeenCalledWith(
		expect.stringContaining('/api/admin/catalog/roles?'),
