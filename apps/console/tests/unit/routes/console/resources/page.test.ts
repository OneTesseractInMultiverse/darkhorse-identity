...
import Page from '../../../../../src/routes/console/resources/+page.svelte';
afterEach(() => vi.unstubAllGlobals());
it('connects the static resources page to the protected catalog and marks its navigation', async () => {
	...
	expect(fetcher).toHaveBeenCalledWith(
		expect.stringContaining('/api/admin/catalog/resources?'),
