...
BEGIN
 ...
 FOREACH statement IN ARRAY ARRAY[
  ...
  'SELECT * FROM operator_catalog_detail_audit',
  'INSERT INTO operator_catalog_detail_audit(operation_id) SELECT operation_id FROM operator_catalog_detail_audit WHERE false',
  'TRUNCATE operator_catalog_detail_audit',
  'SELECT * FROM operator_application_audit',
  'SELECT * FROM operator_client_audit',
  'SELECT * FROM operator_client_secret_audit',
  'INSERT INTO operator_client_secret_audit(operation_id) SELECT operation_id FROM operator_client_secret_audit WHERE false',
  'INSERT INTO operator_client_audit(operation_id) SELECT operation_id FROM operator_client_audit WHERE false',
  'TRUNCATE operator_client_audit',
  'TRUNCATE operator_client_secret_audit',
  'INSERT INTO operator_application_audit(operation_id) SELECT operation_id FROM operator_application_audit WHERE false',
